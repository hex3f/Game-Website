<?php 
	...
	// 请使用UTF-8编码，否则会出错！
	$position = fopen("position.txt", "r") or die("Unable to open file!");
	$data = fgets($position);
	fclose($position);
 ?>
<!DOCTYPE html>
...
<body class="aoide" style="font-family:微软雅黑">
		<main>
			<div class="loader">
			...
			<div id="ticket-wrap">
				<p>
					网站注册服务：<span>正常</span><br>
					服务器状态：<span>开机</span><br>
				</p>
			</div>
			
			<div class="content">
				<nav class="menu">
					<a href="#" class="menu__item" style="font-family:微软雅黑">服务器介绍<div class="empty-space">-</div>Introduce</a>
					<a href="#" class="menu__item" style="font-family:微软雅黑">下载客户端<div class="empty-space">-</div>Download</a>
					<a href="#" class="menu__item" style="font-family:微软雅黑">注册账号<div class="empty-space">-</div>Register</a>
				</nav>
             
				<div class="event-time">
					<div class="section">
						<div class="hero-main-title"><font style="font-family:微软雅黑">镜花水月贰　服务器<br/>删档测试时间</font></div>
						<div class="hero-title">六月 20号</div>
						<div class="hero-subtitle"><span>2</span><span>0</span><span>1</span><span>9</span></div>
					</div>
                   <!--
					<ul class="countdown">
						<li> 
			...
			<div class="content content--reveal">
						...
						<div class="section" id="boxscroll-in-1">
							...
							<div class="section padding-top-big">
								<div class="container">
									<div class="row">
										<div class="col-md-12">
											<h2 class="content__title">服务器介绍</h2>
										</div>
										<div class="col-lg-4 mt-3">
											<h3 class="content__subtitle">Server introduction</h3>
										</div>
									</div>
								</div>
							</div>							
								...
								<div class="container">
									<div class="row">
										<div class="offset-md-3 col-md-9">
											<h4>关于服务器</h4>
											<img src="img/t2.jpg" width="800px" height="100px" style="padding:10px"/>
											<div class="title-page-line mt-4 mb-5"></div>
										</div>
										<div class="col-md-9 mt-4 mt-md-0">
											<h4>这是一个什么样的服务器？</h4>
											<p><em>What kind of server is this?</em></p>
											<h5>这是一个RPG服务器</h5>
											<div class="social-team mt-4">
												<a href="register.php">马上注册账号</a>
											</div>
										</div>
										<div class="col-md-9 mt-4 mt-md-5">
											<div class="title-page-line mt-4 mb-5" style="padding-top:10px;width:50%"></div>
											<h4>关于我们 &amp; 联系我们</h4>
							...
							<div class="section padding-top padding-bottom-big background-dark footer">
								<div class="container">
									<div class="row">
										...
										<div class="col-md-12">
											<h5>Copyright © 2019 mcjhsy.com All Rights Reserved</h5>
										</div>
									</div>
								</div>
							</div>						
						...
						<div class="section" id="boxscroll-in-4">
							...
							<div class="section padding-top-big">
								<div class="container">
									<div class="row">
										<div class="col-md-12">
											<h2 class="content__title" style="font-family:微软雅黑">下载客户端</h2>
										</div>
										<div class="col-lg-4 mt-3">
											<h3 class="content__subtitle">Download client apps</h3>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="row">
										...
										<div class="col-md-4">
											<div class="blog-wrap pb-4">
												...
												<a href="#"><h5 class="px-4 mb-3" style="text-align:center;padding-bottom:10px;">下载纯净端</h5></a>
											</div>
										</div>
										<div class="col-md-4">
											<div class="blog-wrap pb-4">
												<a href="#"><img src="img/blog/1.png" alt=""></a>
												<a href="#"><h5 class="px-4 mb-3" style="text-align:center;padding-bottom:10px;">其他下载</h5></a>
											</div>
										</div>
										-->
				...
				<div class="content__inner"  style="background:black;">
						...
						<div class="section" id="boxscroll-in-5">
							...
							<div class="section padding-top-big">
								<div class="container">
									<div class="row">
										<div class="col-md-12">
											<h2 class="content__title" style="font-family:微软雅黑">注册账号</h2>
										</div>
										<div class="col-lg-4 mt-3">
											<h3 class="content__subtitle">Registered account</h3>
										</div>
									</div>
								</div>
							</div>
							<h3 class="content__title" style="font-family:微软雅黑;text-align:center;padding:10px">玩家大数据</h3>
							
							<!-- 热力图 DIV start -->
							<div id="map" style="padding-top: 800px;margin:0 auto;"></div>			
							<!-- 热力图 DIV end -->
							
								<div class="container">
									<div class="row">		
										<div class="offset-md-3 col-md-12">
											<h4 style="font-family:微软雅黑">注册</h4>
											<div class="title-page-line mt-4 mb-5"></div>
										</div>	
										<div class="offset-md-3 col-md-12" style="text-align:center">
											<h5 style="font-family:微软雅黑">我们是一个超有激情的团队，激情需要一直注入新鲜血脉才能永远的保持。所以，加入我们服务器吧！</h5>
											<h5 style="font-family:微软雅黑">服务器无法注册账号，你只能在网站内注册。赶紧注册一个账号吧！</h5>
										</div>											
										<div class="col-lg-9 mt-4 mt-lg-0" id="ajax-form" style="padding:10px;text-align:center">
											<div id="button-con"><button class="send_message" id="send" onclick="window.location.href='register.php'"><span>立即注册账号</span></button></div>					
										</div>									
										<div class="col-lg-9 mt-4 mt-lg-5">
											<div class="subscribe-text">
												<p>* 请认真填写这些信息，这些信息十分重要！</p>
											</div>
										</div>
									</div>
								</div>						
			...
			<div class="location-fixed">
				<p>Copyright © 2019 mcjhsy.com All Rights Reserved</p>
			</div>
	...
	<script type="text/javascript">
		...
		map.centerAndZoom(new BMap.Point(105, 38), How_map);  // 初始化地图,设置中心点坐标和地图级别
		...
		//    var a = handleEventData('{"groupName":"push_ips","modelName":"推送设备",ips:[[73.96,39.707],[74.092,39.809],[74.18,39.775],[74.443,39.809],[74.443,39.775],[74.531,39.809],[74.575,40.011],[74.707,39.842],[74.751,38.72],[74.839,37.16],[74.883,38.754],[74.883,38.204],[74.927,39.775],[74.927,38.651],[74.971,38.651],[74.971,38.617],[74.971,38.273],[74.971,38.204],[75.015,39.741],[75.015,39.673],[75.059,39.402],[75.059,38.411],[75.059,38.031],[75.146,38.754],[75.146,38.342]]}')
		...
		//初始化百度地图图层=-------结束
		var positionA = '{"groupName":"push_ips","modelName":"镜花水月","ips": [';
		var positionB = "<?php echo $data; ?>";
		var positionC = ']}';
		positionA+=positionB;
		positionA+=positionC;
		var a = refreshPageData(positionA);
		/**
		 * 刷新数据
		 * @param dt
		 * @param roomGroup
